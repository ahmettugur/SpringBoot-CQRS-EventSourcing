...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccountById(@PathVariable(value = "id") String id){
        try {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccountByHolder(@PathVariable(value = "accountHolder") String accountHolder){
        try {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccountWithBalance(@PathVariable(value = "equalityType") EqualityType equalityType,
